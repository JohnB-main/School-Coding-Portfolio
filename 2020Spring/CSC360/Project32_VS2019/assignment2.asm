...
; This progam takes a positive number (or zero) from a user and adds 50, then returns the new number
; Author: John Booker
; Date 2/4/2002
...
prompt BYTE "Enter a positive number:", 0	;prompt for getting a number from the user
